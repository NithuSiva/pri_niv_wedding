// Sauvegarde la langue et lance le loader
function selectLang(lang) {
    // localStorage.setItem('wedding-lang', lang);
    
    // Cacher l'écran de langue
    document.getElementById('language-screen').style.display = 'none';
    document.body.classList.remove('lang-pending');
    
    // 🔥 IMPORTANT : Réactiver le scroll immédiatement
    document.body.style.overflow = '';
    document.body.style.position = '';
    document.body.style.width = '';
    document.documentElement.style.overflow = '';
    
    // Afficher le content-screen tout de suite (avant le loader)
    
    
    // Lancer le loader, puis appliquer la langue
    if (window.initLoader) {
        window.initLoader(() => {
            // Cette fonction s'exécute après le chargement
            applyLang(lang);
            
            // Initialiser les animations GSAP ici si nécessaire
        ...
        // Fallback si loader non disponible
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (saved) {
        // Langue déjà choisie : on cache language-screen et on lance le loader
        document.getElementById('language-screen').style.display = 'none';
        document.body.classList.remove('lang-pending');
        
        // 🔥 IMPORTANT : Réactiver le scroll
        document.body.style.overflow = '';
        document.body.style.position = '';
        document.body.style.width = '';
        document.documentElement.style.overflow = '';
        ...
        // Cacher le loader en attendant le choix
...
function goBack() {
    ...
    // Réinitialiser le loader pour la prochaine fois
    const loader = document.getElementById('loader');
    if (loader) {
...
const translations = {
  fr: {
    ...
    "rec-title": "Réception de Mariage",
    "rel-title": "Mariage Religieux",
    ...
    "tl-desc-full-5": "Le marié subit un rituel de purification : &lt;/li&gt;&lt;li&gt;On lui remet un Therpai (une bague faite d'herbe darbha) à porter, symbolisant la pureté mentale et la concentration. &lt;/li&gt;&lt;li&gt;Un fil de safran (kaapu) est noué autour de son poignet droit par le prêtre, servant de protection spirituelle contre les mauvais vœux et l'énergie négative.",
    ...
    "tl-desc-full-7": "Le marié offre à la mariée deux objets sacrés : &lt;/li&gt;&lt;li&gt;Koorai Pudavai : le sari de mariage, offert par la famille du marié. &lt;/li&gt;&lt;li&gt;Thali : le pendentif en or sacré. C'est le symbole du mariage. &#10;Les deux objets sont placés sur un plateau, bénis par le prêtre, puis circulés parmi les invités afin que chacun puisse les toucher et leur transmettre ses bénédictions. La mariée quitte ensuite la scène pour revêtir le sari Koorai.",
  ...
  en: {
    ...
    "rec-title" : "Wedding Reception",
    "rel-title" : "Religious Ceremony",
    ...
    "tl-desc-full-5" : "The groom undergoes a purification ritual: &lt;/li&gt;&lt;li&gt;He is given a Therpai (a ring made of darbha grass) to wear, symbolising mental purity and focus. &lt;/li&gt;&lt;li&gt;A saffron thread (kaapu) is tied around his right wrist by the priest, serving as spiritual protection against ill wishes and negative energy.",
    ...
    "tl-desc-full-7" : "The groom presents the bride with two sacred items: &lt;/li&gt;&lt;li&gt;Koorai Pudavai: the wedding saree, gifted by the groom's family. &lt;/li&gt;&lt;li&gt;Thali: the sacred gold pendant. It is the symbol of marriage. &#10;Both items are placed on a tray, blessed by the priest, and then circulated among the assembled guests so that everyone may touch them and impart their blessings. The bride then leaves the stage to change into the Koorai saree.",
 ...
 ta: {
    ...
    "rec-title": "திருமண வரவேற்பு",
    "rel-title": "மதச் சடங்கு திருமணம்",
    ...
    "tl-desc-full-5": "மணமகன் ஒரு சுத்திகரிப்பு சடங்கிற்கு உட்படுகிறார்: &lt;/li&gt;&lt;li&gt;அவருக்கு தர்ப்பை புல்லால் செய்யப்பட்ட தெர்பை (மோதிரம்) அணியப்படுகிறது, இது மன தூய்மை மற்றும் கவனத்தை அடையாளப்படுத்துகிறது. &lt;/li&gt;&lt;li&gt;காப்பு என்ற குங்கும நூல் பூசாரியால் அவரது வலது மணிக்கட்டில் கட்டப்படுகிறது, இது தீய எண்ணங்கள் மற்றும் எதிர்மறை சக்திகளுக்கு எதிரான ஆன்மீக பாதுகாப்பாக செயல்படுகிறது.",
    ...
    "tl-desc-full-7": "மணமகன் மணமகளுக்கு இரண்டு புனித பொருட்களை வழங்குகிறார்: &lt;/li&gt;&lt;li&gt;கூரை புடவை: மணமகனின் குடும்பத்தினர் பரிசளித்த திருமண புடவை. &lt;/li&gt;&lt;li&gt;தாலி: புனித தங்க பதக்கம். இது திருமணத்தின் அடையாளம். &#10;இரண்டு பொருட்களும் ஒரு தட்டில் வைக்கப்பட்டு, பூசாரியால் ஆசீர்வதிக்கப்பட்டு, அனைவரும் தொட்டு ஆசீர்வாதம் வழங்கும் வகையில் கூடியிருந்த விருந்தினர்களிடையே சுற்றி வரவிடப்படுகின்றன. பின்னர் மணமகள் கூரை புடவை அணிய மேடையை விட்டு வெளியேறுகிறாள்.",
